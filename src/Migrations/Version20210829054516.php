 ...
 */
final class Version20210829054516 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE transport (name VARCHAR(255) NOT NULL, public_key VARCHAR(255) DEFAULT NULL, PRIMARY KEY(name))');
